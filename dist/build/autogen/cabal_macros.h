...
/* package PFP-Lab1-0.1.0.0 */
#define VERSION_PFP_Lab1 "0.1.0.0"
#define MIN_VERSION_PFP_Lab1(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
/* package criterion-1.4.0.0 */
#define VERSION_criterion "1.4.0.0"
...
/* package lists-0.4.2 */
#define VERSION_lists "0.4.2"
#define MIN_VERSION_lists(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  4 || \
...
#define CURRENT_COMPONENT_ID "PFP-Lab1-0.1.0.0"

#define CURRENT_PACKAGE_KEY "PFP-Lab1-0.1.0.0"
